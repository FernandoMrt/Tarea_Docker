<h1 align="center">
  <br>
    <img src="https://marketplace-cdn.atlassian.com/files/1c7d3427-1cde-41cf-8668-80a420fc534b" alt="JJAutomatizer" width="400">
  </br>
  <br>
    JJAutomatizer
  <br>
...
- [x] Actualización de estados de los Issues
- [x] Ejecución de Jobs remótamente
- [x] Obtención de archivos cargados en JIRA
- [x] Envío de parámetros JIRA -> Jenkins
- [ ] Scripts Python
- [ ] Envío de parámetros de Jenkins -> JIRA
- [ ] Triggers necesarios
- [ ] Triggers en caso de fallas
- [ ] Múltiprocesos en Jobs de Jenkins
- [ ] Creación del diagrama de flujo en JIRA

Nota:

Existe la mitad del esqueleto, faltan por crear los campos personalizados necesarios para obtener la información necesaria (ip, cliente, infraestructura, tecnologías, etc.), los cuales se pueden conseguir al hacer un scraping al archivo de requerimientos o el SoW, también se pueden crear dichos campos en JIRA.

Con esto ya se podrá tener una demo en fase estilo "Alpha". :)

### Tabla

* [Maguey Lite](#Maguey-Lite)
    - Descripción
...
El contenedor Maguey Lite es una versión de la distribución oficial Maguey ATF V2, el cual solo contiene las herramientas para la fase reconocimiento:

    sslyze - Detecta las versiones SSL/TLS que usa el servidor
    nmap - Descubre los puertos abiertos
    gobuster - Descubre directorios mediante fuerza bruta
    nikto - Escaner de aplicativos web
    photon - Obtiene los recursos mediante scraping 

Al terminar la ejecución devolverá como resultado un listado de archivos.

Dentro del directorio [Maguey_Lite_V1](Mague_Lite_V1) existe el archivo Dockerfile para la compilación del contenedor y el archivo ejecución.sh que permite lanzar las herramientas del contenedor mediante el sitio.
...
certbot certonly --standalone --preferred-challenges http -d www.secappjenkins.ml
...
* [API JIRA](https://developer.atlassian.com/cloud/jira/platform/rest/v2/intro/#about)
* [API JENKINS](https://www.jenkins.io/doc/book/using/remote-access-api/)
* [JIRA SMART VALUES](https://support.atlassian.com/jira-software-cloud/docs/smart-values-general/)
